...
of the list at worst case and N(N!)/2 on average case which is still N(N!). The extra N multiplied is because inside every permutation, you run over the whole list to check if it is sorted or not. The best case for me would be a 
